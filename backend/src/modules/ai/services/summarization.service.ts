...
import { ArticleRepository, IArticleRepository } from '../../../modules/articles/repositories/article.repository';
...
export class SummarizationService implements ISummarizationService {
    ...
    private async generateAISummary(title: string, body: string): Promise<string> {
